...
/***/ "./src/app sync recursive ^\\.\\/(?!.*(?:__tests__)).*\\.(tsx?)$":
/*!**********************************************************!*\
...
var map = {
	"./factory.ts": "./src/app/factory.ts",
	"./jest-dom.d.ts": "./src/app/jest-dom.d.ts",
	"./model/defaults.ts": "./src/app/model/defaults.ts",
	"./model/model.ts": "./src/app/model/model.ts",
	"./observers.ts": "./src/app/observers.ts",
	"./presenter/presenter.ts": "./src/app/presenter/presenter.ts",
	"./toxinSlider.d.ts": "./src/app/toxinSlider.d.ts",
	"./view/defaults.ts": "./src/app/view/defaults.ts",
	"./view/diapason/diapason.ts": "./src/app/view/diapason/diapason.ts",
	"./view/diapason/xDiapason/xDiapason.ts": "./src/app/view/diapason/xDiapason/xDiapason.ts",
	"./view/output/output.ts": "./src/app/view/output/output.ts",
	"./view/output/xOutput/xOutput.ts": "./src/app/view/output/xOutput/xOutput.ts",
	"./view/progressBar/progressBar.ts": "./src/app/view/progressBar/progressBar.ts",
	"./view/progressBar/xProgressBar/xProgressBar.ts": "./src/app/view/progressBar/xProgressBar/xProgressBar.ts",
	"./view/runner/runner.ts": "./src/app/view/runner/runner.ts",
	"./view/runner/xRunner/xRunner.ts": "./src/app/view/runner/xRunner/xRunner.ts",
	"./view/scale/scale.ts": "./src/app/view/scale/scale.ts",
	"./view/scale/xScale/xScale.ts": "./src/app/view/scale/xScale/xScale.ts",
	"./view/scaleValues/scaleValues.ts": "./src/app/view/scaleValues/scaleValues.ts",
	"./view/scaleValues/xScaleValues/xScaleValues.ts": "./src/app/view/scaleValues/xScaleValues/xScaleValues.ts",
	"./view/tip/tip.ts": "./src/app/view/tip/tip.ts",
	"./view/tip/xTip/xTip.ts": "./src/app/view/tip/xTip/xTip.ts",
	"./view/view.ts": "./src/app/view/view.ts"
};
...
webpackContext.id = "./src/app sync recursive ^\\.\\/(?!.*(?:__tests__)).*\\.(tsx?)$";
...
var view_ts_1 = __webpack_require__(/*! ./view/view.ts */ "./src/app/view/view.ts");
var model_ts_1 = __webpack_require__(/*! ./model/model.ts */ "./src/app/model/model.ts");
var presenter_ts_1 = __webpack_require__(/*! ./presenter/presenter.ts */ "./src/app/presenter/presenter.ts");
(function ($) {
    $.fn.toxinSlider = function (method, args) {
        var modelData = $(this).data("toxinSliderModel") ? $(this).data("toxinSliderModel").model : null;
        var init = function (options) {
            this.each(function () {
                if (modelData)
                    return;
                var model = new model_ts_1["default"](options);
                var view = new view_ts_1["default"](this);
                var presenter = new presenter_ts_1["default"](model, view);
...
exports.__esModule = true;
exports.defaultSliderSettingsModel = void 0;
exports.defaultSliderSettingsModel = {
    extraClass: '',
    start: 0,
    end: 100,
    step: 1,
...
exports.__esModule = true;
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var observers_ts_1 = __webpack_require__(/*! ../observers.ts */ "./src/app/observers.ts");
var defaults_ts_1 = __webpack_require__(/*! ./defaults.ts */ "./src/app/model/defaults.ts");
var ToxinSliderModel = /** @class */ (function () {
    function ToxinSliderModel(options) {
        this.subjectModelUpdateState = new observers_ts_1["default"]();
        this.subjectModelChangeCurrent = new observers_ts_1["default"]();
        this.state = {};
        this.get = {
            current: function () {
        ...
        for (var key in defaults_ts_1.defaultSliderSettingsModel) {
            this.state[key] = defaults_ts_1.defaultSliderSettingsModel[key];
        }
    ...
    ToxinSliderModel.prototype.executeMethod = function (method, args) {
        if (method === 'get') {
            this.get[args]();
        }
        else if (this[method]) {
    ...
    ToxinSliderModel.prototype.returnDecimalPlaces = function (num) {
        var decimalPlaces = num.toString().includes('.') ? num.toString().split('.')[1].length : 0;
        return decimalPlaces;
    };
    ToxinSliderModel.prototype.synchronizeSettings = function () {
    ...
    ToxinSliderModel.prototype.setState = function (options) {
        this.state = $.extend(this.state, options);
        this.synchronizeSettings();
    };
    ToxinSliderModel.prototype.update = function (options) {
        this.setState(options);
        this.subjectModelUpdateState.notifyObservers();
    };
    ToxinSliderModel.prototype.setCurrent = function (current) {
        this.state.current = current;
        this.synchronizeSettings();
        this.subjectModelChangeCurrent.notifyObservers();
    };
    return ToxinSliderModel;
}());
exports["default"] = ToxinSliderModel;
...
exports.__esModule = true;
var ObservableSubject = /** @class */ (function () {
    ...
    ;
    ObservableSubject.prototype.notifyObservers = function (data) {
...
exports["default"] = ObservableSubject;
...
exports.__esModule = true;
var ToxinSliderPresenter = /** @class */ (function () {
    function ToxinSliderPresenter(model, view) {
        this.model = model;
        this.view = view;
        var that = this;
    ...
    return ToxinSliderPresenter;
}());
exports["default"] = ToxinSliderPresenter;
...
exports.__esModule = true;
exports.defaultSliderSettingsView = void 0;
exports.defaultSliderSettingsView = {
    extraClass: '',
    min: 0,
    max: 100,
    step: 1,
...
exports.__esModule = true;
var Diapason = /** @class */ (function () {
    function Diapason() {
        this.diapasonEl = document.createElement('div');
    }
    return Diapason;
}());
;
exports["default"] = Diapason;
...
exports.__esModule = true;
__webpack_require__(/*! ./xDiapason.css */ "./src/app/view/diapason/xDiapason/xDiapason.css");
var diapason_ts_1 = __webpack_require__(/*! ../diapason.ts */ "./src/app/view/diapason/diapason.ts");
var XDiapason = /** @class */ (function (_super) {
    __extends(XDiapason, _super);
    function XDiapason() {
        var _this = _super.call(this) || this;
        _this.diapasonEl.className = 'diapason x-diapason';
        return _this;
    }
    return XDiapason;
}(diapason_ts_1["default"]));
;
exports["default"] = XDiapason;
...
var Output = /** @class */ (function () {
    ...
    Output.prototype.dispatchEvent = function () {
...
exports.__esModule = true;
var output_ts_1 = __webpack_require__(/*! ../output.ts */ "./src/app/view/output/output.ts");
var XOutput = /** @class */ (function (_super) {
    __extends(XOutput, _super);
    function XOutput(options) {
        var _this = _super.call(this, options) || this;
        _this.setValue(options.current);
        return _this;
    }
    XOutput.prototype.setValue = function (value) {
        this.outputEl.value = value.toString();
    };
    XOutput.prototype.countOutputValue = function (elBar, stepsAmount, start, end, step, decimalPlaces) {
        var outputValue;
...
exports.__esModule = true;
__webpack_require__(/*! ./progressBar.css */ "./src/app/view/progressBar/progressBar.css");
var ProgressBar = /** @class */ (function () {
    ...
    ProgressBar.prototype.setFontSize = function (scaleStepVal) {
...
exports.__esModule = true;
__webpack_require__(/*! ./xProgressBar.css */ "./src/app/view/progressBar/xProgressBar/xProgressBar.css");
var progressBar_ts_1 = __webpack_require__(/*! ../progressBar.ts */ "./src/app/view/progressBar/progressBar.ts");
var XProgressBar = /** @class */ (function (_super) {
    __extends(XProgressBar, _super);
    function XProgressBar(options) {
        var _this = _super.call(this, options) || this;
        _this.progressBarEl.className = 'progress-bar x-progress-bar';
        _this.setCurrent(options.current, options.min, options.max, options.step);
        _this.test = _this.test.bind(_this);
        document.addEventListener("DOMContentLoaded", _this.test);
        return _this;
    }
    XProgressBar.prototype.test = function () {
        this.setFontSize(this.returnProgressBarStep());
    };
    XProgressBar.prototype.setFontSize = function (scaleStepVal) {
        this.progressBarEl.style.fontSize = scaleStepVal + 'px';
    };
    XProgressBar.prototype.returnProgressBarStep = function () {
        return parseFloat(getComputedStyle(this.progressBarEl).width) * this.stepsCoefficient / this.stepsAmount;
    };
    XProgressBar.prototype.countProgressBarSize = function (event, scaleStartX, scaleStep, mousePosOnRunner) {
        var scaleValue = event.clientX - scaleStartX - mousePosOnRunner;
        var size;
        if (scaleValue >= 0) {
    ...
    XProgressBar.prototype.setCurrent = function (current, start, end, step) {
    ...
    return XProgressBar;
}(progressBar_ts_1["default"]));
;
exports["default"] = XProgressBar;
...
var Runner = /** @class */ (function () {
    function Runner() {
        this.runnerEl = document.createElement('div');
    }
    Runner.prototype.setMarginLeft = function (progressBarEl) { };
    return Runner;
}());
;
...
exports.__esModule = true;
__webpack_require__(/*! ./xRunner.css */ "./src/app/view/runner/xRunner/xRunner.css");
var runner_ts_1 = __webpack_require__(/*! ../runner.ts */ "./src/app/view/runner/runner.ts");
var XRunner = /** @class */ (function (_super) {
    __extends(XRunner, _super);
    function XRunner() {
        var _this = _super.call(this) || this;
        _this.runnerEl.className = 'runner x-runner';
        return _this;
    }
    XRunner.prototype.returnMousePosOnRunner = function (pointerDownEvent) {
        return pointerDownEvent.clientX - this.runnerEl.getBoundingClientRect().left;
    };
    return XRunner;
}(runner_ts_1["default"]));
;
exports["default"] = XRunner;
...
exports.__esModule = true;
__webpack_require__(/*! ./xScale.css */ "./src/app/view/scale/xScale/xScale.css");
var scale_ts_1 = __webpack_require__(/*! ../scale.ts */ "./src/app/view/scale/scale.ts");
var XScale = /** @class */ (function (_super) {
    __extends(XScale, _super);
    function XScale(options) {
        var _this = _super.call(this, options) || this;
        _this.scaleEl.className = 'scale x-scale';
        return _this;
    }
    XScale.prototype.returnScaleStart = function () {
    ...
    XScale.prototype.returnScaleStep = function (runnerEl) {
...
exports.__esModule = true;
var ScaleValues = /** @class */ (function () {
    function ScaleValues() {
        this.scaleValuesEl = document.createElement('div');
        this.scaleValuesModTurner = 'number';
    }
    return ScaleValues;
}());
;
exports["default"] = ScaleValues;
...
exports.__esModule = true;
__webpack_require__(/*! ./xScaleValues.css */ "./src/app/view/scaleValues/xScaleValues/xScaleValues.css");
var scaleValues_ts_1 = __webpack_require__(/*! ../scaleValues.ts */ "./src/app/view/scaleValues/scaleValues.ts");
var XScaleValues = /** @class */ (function (_super) {
    __extends(XScaleValues, _super);
    function XScaleValues() {
        var _this = _super.call(this) || this;
        _this.setScaleValuesMod();
        return _this;
    }
    XScaleValues.prototype.setScaleValuesMod = function () {
    ...
    XScaleValues.prototype.setScaleValues = function (scaleValuesAmount, start, end, step, decimalPlaces, progressBarFontSize, runnerEl) {
        var runnerWidth = parseFloat(getComputedStyle(runnerEl).width);
        var result = '<div class="scale-value" style="left: 0">' + start + '</div>';
        for (var i = 1; i < scaleValuesAmount - 1; i++) {
            var stepsAmountInOneValue = Math.round(((end - start) / step) / (scaleValuesAmount - 1));
        ...
        var scaleValues = this.scaleValuesEl.getElementsByClassName('scale-value');
        ;
        for (var i = 0; i < scaleValues.length; i++) {
            scaleValues[i].style.left = parseFloat(scaleValues[i].style.left) - parseFloat(getComputedStyle(scaleValues[i]).width) / 2 + 'px';
        }
    };
    XScaleValues.prototype.render = function (scaleEl, scaleValues) {
    ...
    return XScaleValues;
}(scaleValues_ts_1["default"]));
;
exports["default"] = XScaleValues;
...
exports.__esModule = true;
__webpack_require__(/*! ./xTip.css */ "./src/app/view/tip/xTip/xTip.css");
var tip_ts_1 = __webpack_require__(/*! ../tip.ts */ "./src/app/view/tip/tip.ts");
var XTip = /** @class */ (function (_super) {
    __extends(XTip, _super);
    function XTip() {
        var _this = _super.call(this) || this;
        _this.tipEl.className = "tip x-tip";
        return _this;
    }
    XTip.prototype.setCurrent = function (current, start, end) {
        this.tipEl.innerHTML = current;
    };
    XTip.prototype.showTip = function (barEl, stepsAmount, start, end, step, decimalPlaces) {
        var outputValue;
...
exports.__esModule = true;
__webpack_require__(/*! ./view.css */ "./src/app/view/view.css");
var defaults_ts_1 = __webpack_require__(/*! ./defaults.ts */ "./src/app/view/defaults.ts");
var observers_ts_1 = __webpack_require__(/*! ../observers.ts */ "./src/app/observers.ts");
var xOutput_ts_1 = __webpack_require__(/*! ./output/xOutput/xOutput.ts */ "./src/app/view/output/xOutput/xOutput.ts");
...
var xScale_ts_1 = __webpack_require__(/*! ./scale/xScale/xScale.ts */ "./src/app/view/scale/xScale/xScale.ts");
...
var xScaleValues_ts_1 = __webpack_require__(/*! ./scaleValues/xScaleValues/xScaleValues.ts */ "./src/app/view/scaleValues/xScaleValues/xScaleValues.ts");
...
var xDiapason_ts_1 = __webpack_require__(/*! ./diapason/xDiapason/xDiapason.ts */ "./src/app/view/diapason/xDiapason/xDiapason.ts");
...
var xRunner_ts_1 = __webpack_require__(/*! ./runner/xRunner/xRunner.ts */ "./src/app/view/runner/xRunner/xRunner.ts");
...
var xTip_ts_1 = __webpack_require__(/*! ./tip/xTip/xTip.ts */ "./src/app/view/tip/xTip/xTip.ts");
...
var xProgressBar_ts_1 = __webpack_require__(/*! ./progressBar/xProgressBar/xProgressBar.ts */ "./src/app/view/progressBar/xProgressBar/xProgressBar.ts");
...
var ToxinSliderView = /** @class */ (function () {
    function ToxinSliderView(input) {
        this.subjectViewChangeCurrent = new observers_ts_1["default"]();
        ...
        for (var key in defaults_ts_1.defaultSliderSettingsView) {
            this.sliderSettings[key] = defaults_ts_1.defaultSliderSettingsView[key];
        }
        this.input = input;
        this.setState();
        this.render();
    }
    ToxinSliderView.prototype.setState = function () {
        ...
        this.state.output = new xOutput_ts_1["default"]({ input: this.input, current: this.sliderSettings.current });
        this.state.scale = new xScale_ts_1["default"]({ min: this.sliderSettings.min, max: this.sliderSettings.max, step: this.sliderSettings.step });
        this.state.scaleValues = new xScaleValues_ts_1["default"]();
        this.state.diapasones.push(new xDiapason_ts_1["default"]());
        this.state.runners.push(new xRunner_ts_1["default"]());
        this.state.tips.push(new xTip_ts_1["default"]());
        this.state.progressBars.push(new xProgressBar_ts_1["default"]({ min: this.sliderSettings.min, max: this.sliderSettings.max, step: this.sliderSettings.step, current: this.sliderSettings.current }));
    ...
    ToxinSliderView.prototype.render = function () {
        this.sliderEl = document.createElement('div');
    ...
    return ToxinSliderView;
}());
exports["default"] = ToxinSliderView;
...
var map = {
	...
	"./inptNumber/inptNumber.js": "./src/components/inptNumber/inptNumber.js",
	"./radio/radio.js": "./src/components/radio/radio.js",
	"./sliderWithPanel/sliderWithPanel.js": "./src/components/sliderWithPanel/sliderWithPanel.js"
};
...
function hangCheckboxesHandler() {
  ...
  var _loop = function _loop(i) {
    var checkboxInpt = checkboxes[i].getElementsByClassName('checkbox__inpt')[0]; //        if (checkboxes[i].getElementsByClassName('checkbox__hidden')[0].checked) {
...
/***/ "./src/components/inptNumber/inptNumber.css":
/*!**************************************************!*\
  !*** ./src/components/inptNumber/inptNumber.css ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./src/components/inptNumber/inptNumber.js":
/*!*************************************************!*\
  !*** ./src/components/inptNumber/inptNumber.js ***!
  \*************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _inptNumber_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./inptNumber.css */ "./src/components/inptNumber/inptNumber.css");
/* harmony import */ var _inptNumber_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_inptNumber_css__WEBPACK_IMPORTED_MODULE_0__);

var inptNumbers = document.getElementsByClassName('inpt-number');

var _loop = function _loop(i) {
  var minus = inptNumbers[i].getElementsByClassName('inpt-number__minus')[0];
  var value = inptNumbers[i].getElementsByClassName('inpt-number__value')[0];
  var plus = inptNumbers[i].getElementsByClassName('inpt-number__plus')[0];
  var inpt = inptNumbers[i].getElementsByClassName('inpt-number__inpt')[0];
  var stepIntervalId = void 0;
...
for (var i = 0; i < inptNumbers.length; i++) {
  _loop(i);
}
...
var _loop = function _loop(i) {
  var radioInpt = radios[i].getElementsByClassName('radio__inpt')[0];
  radioInpt.addEventListener('change', function () {
    var radioArr = document.getElementsByName(radios[i].getElementsByClassName('radio__inpt')[0].name);
...
/***/ "./src/components/sliderWithPanel/sliderWithPanel.css":
/*!************************************************************!*\
  !*** ./src/components/sliderWithPanel/sliderWithPanel.css ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/components/sliderWithPanel/sliderWithPanel.js":
/*!***********************************************************!*\
  !*** ./src/components/sliderWithPanel/sliderWithPanel.js ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sliderWithPanel_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sliderWithPanel.css */ "./src/components/sliderWithPanel/sliderWithPanel.css");
/* harmony import */ var _sliderWithPanel_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_sliderWithPanel_css__WEBPACK_IMPORTED_MODULE_0__);
...
function synchronizePanelWithSlider(sliderInpt, el, min, max, step, scaleValues, scaleValuesAmount, direction, range, tip, separator, to, from) {
  var minInpt = el.getElementsByClassName('slider-with-panel__min-inpt')[0];
  var maxInpt = el.getElementsByClassName('slider-with-panel__max-inpt')[0];
  var fromInpt = el.getElementsByClassName('slider-with-panel__from-inpt')[0];
  var toInpt = el.getElementsByClassName('slider-with-panel__to-inpt')[0];
  var stepInpt = el.getElementsByClassName('slider-with-panel__step-inpt')[0];
  var scaleValuesInpt = el.getElementsByClassName('slider-with-panel__scale-values-inpt')[0];
  var scaleValuesAmountInpt = el.getElementsByClassName('slider-with-panel__scale-values-amount-inpt')[0];
  var directionInpts = el.getElementsByClassName('slider-with-panel__direction-inpt');
  var rangeInpts = el.getElementsByClassName('slider-with-panel__range-inpt');
  var tipInpt = el.getElementsByClassName('slider-with-panel__tip-inpt')[0];

  var updateSettingsOnInput = function updateSettingsOnInput() {
    var currentSetting = rangeInpts[0].checked ? +toInpt.value : [+fromInpt.value, +toInpt.value];
    var directionSetting = directionInpts[0].checked ? 'x' : 'y';
    var rangeSetting = rangeInpts[0].checked ? false : true;
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('update', {
      start: +minInpt.value,
      end: +maxInpt.value,
      step: +stepInpt.value,
    ...
    toInpt.value = rangeSetting ? jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('get', 'current')[1] : jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('get', 'current');
    toInpt.nextElementSibling.value = toInpt.value;
    fromInpt.value = rangeSetting ? jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('get', 'current')[0] : minInpt.value;
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider({
    start: min,
    end: max,
    step: step,
  ...
  fromInpt.value = range ? jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('get', 'current')[0] : min;
  fromInpt.dispatchEvent(new Event('input'));
  toInpt.value = range ? jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('get', 'current')[1] : jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('get', 'current');
  toInpt.dispatchEvent(new Event('input')); //scaleValues    

  scaleValuesInpt.onchange = updateSettingsOnInput; //tip    

  tipInpt.onchange = updateSettingsOnInput; //from    
  ...
  directionInpts[1].onchange = updateSettingsOnInput; //range    

  rangeInpts[0].onchange = updateSettingsOnInput;
  rangeInpts[1].onchange = updateSettingsOnInput; //sliderInpt

  sliderInpt.oninput = function () {
    if (!(jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('get', 'current') instanceof Array)) {
      toInpt.value = jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('get', 'current');
      toInpt.nextElementSibling.value = toInpt.value;
      toInpt.nextElementSibling.style.width = (toInpt.nextElementSibling.value.length + 1) * 8 + 'px';
    } else {
      fromInpt.value = jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('get', 'current')[0];
      fromInpt.nextElementSibling.value = fromInpt.value;
      fromInpt.nextElementSibling.style.width = (fromInpt.nextElementSibling.value.length + 1) * 8 + 'px';
      toInpt.value = jquery__WEBPACK_IMPORTED_MODULE_1__(sliderInpt).toxinSlider('get', 'current')[1];
      toInpt.nextElementSibling.value = toInpt.value;
      toInpt.nextElementSibling.style.width = (toInpt.nextElementSibling.value.length + 1) * 8 + 'px';
    }
  };
...
/* harmony default export */ __webpack_exports__["default"] = (synchronizePanelWithSlider);
...
requireAll(__webpack_require__("./src/app sync recursive ^\\.\\/(?!.*(?:__tests__)).*\\.(tsx?)$")); // pattern to take each .ts files except of the ones with __tests__ directory https://regex101.com/r/J8NWTj/1
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_sliderWithPanel_sliderWithPanel_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/sliderWithPanel/sliderWithPanel.js */ "./src/components/sliderWithPanel/sliderWithPanel.js");



var panels = document.getElementsByClassName('slider-with-panel'); //synchronizePanelWithSlider(sliderInpt, el, min, max, step, scaleValues, scaleValuesAmount, direction, range, tip, separator, to, from);
