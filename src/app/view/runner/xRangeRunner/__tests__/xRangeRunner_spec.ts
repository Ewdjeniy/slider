...
import XRangeRunner from '../xRangeRunner.ts';
        
const testXRangeRunner = function(sliderSettings) {
         
    describe('XRangeRunner', function() {
        ...
        it('Должен быть объявлен', function() {
            expect(XRangeRunner).toBeDefined();
        });
...
export default testXRangeRunner;