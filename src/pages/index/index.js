...
synchronizePanelWithSlider(panels[0].getElementsByClassName('first-slider')[0], panels[0], 0, 100, 1, true, 3, 'x', false, true, ' - ', 25, 0);

synchronizePanelWithSlider(panels[1].getElementsByClassName('second-slider')[0], panels[1], -50, 50, 1, true, 3, 'x', true, false, ' - ', 25, 0);

synchronizePanelWithSlider(panels[2].getElementsByClassName('third-slider')[0], panels[2], 0, 1000, 10, true, 3, 'y', false, true, ' - ', 100, 0);
